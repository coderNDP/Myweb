...
<p>Update Customer</p>
  <div class="group">
    <input required="true" class="main-input" type="text" name='username' value='{{ $customer->username}}'>
  ...
  <br>
  <div class="group">
    <input required="true" class="main-input" type="email" name='email' value='{{ $customer->email}}' >
    <span class="highlight-span"></span>
