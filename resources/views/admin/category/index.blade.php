...
<div class="main" style="margin-left:50px;">
  ...
  <a href="{{ route('category.create') }}"  style="text-decoration-line: none;">
<button type="button" class="button_4" style="margin-left: 100px; margin-top: 50px; background-image: linear-gradient(to right, #fc5c7d, #6a82fb);">
  ...
  <tr>
    ...
    <tr>
        ...
        <div style="margin-top: 10px;"><a href="{{ route('category.edit', $cat->id_category)}}">
        ...
        <!-- @foreach($results as $child)
            ...
            <tr>
                ...
                <td >
                    <table>
                        <tr>
                            <td style='width: 10%'>{{ $child->id_category }}</td>
                            <td style='width: 70%'> {{ $child->name_category }}</td>
                            <td >
                            <div><a href=''>
                            ...
                            <div style="margin-top: 10px;"><a style="text-decoration-line: none;" href=''>
