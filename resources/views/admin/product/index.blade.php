                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless text-white mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img style='width: 70px; height: 70px;' src='/img/{{$pro->img}}'>
                                                </td>
                                                <td>{{$pro->name}}</td>
                                                ...
                                                <td>{{$pro->Des}}</td>
                                                <td>
                                                <form action="{{ route('product.destroy', $pro->id_product) }}" method="post">
                                                    @csrf @method('DELETE')
                                                    <div>
                                                    ...
                                                    <div style="margin-top: 10px;"><a href="{{ route('product.edit', $pro->id_product)}}">
